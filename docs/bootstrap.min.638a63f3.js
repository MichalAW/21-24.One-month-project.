        ...
        !(function(e, t) {
          ...
          function Me(e, t, n, r) {
            ...
            if (
              ...
              for (u = (a = w.map(he(i, 'script'), He)).length; f < p; f++)
                (l = i),
                  f !== d &&
                    ((l = w.clone(l, !0, !0)), u && w.merge(a, he(l, 'script'))),
                  n.call(e[f], l, f);
              if (u)
                for (c = a[a.length - 1].ownerDocument, w.map(a, Oe), f = 0; f < u; f++)
                  (l = a[f]),
                    pe.test(l.type || '') &&
          ...
          w.extend({
            ...
            clone: function(e, t, n) {
              ...
              return (
                (a = he(c, 'script')).length > 0 && ge(a, !f && he(e, 'script')), c
              );
            },
          ...
          w.ajaxSetup({
            ...
            w.each(['top', 'left'], function(e, t) {
              w.cssHooks[t] = Fe(g.pixelPosition, function(e, n) {
                if (n)
                  return (n = Be(e, t)), Ie.test(n) ? w(e).position()[t] + 'px' : n;
              });
            }),
